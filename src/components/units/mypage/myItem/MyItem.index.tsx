...
import Paginations from "../../../commons/paginations/01/Paginations.container";
...
export default function MyItemPage(): JSX.Element {
  const [menu, setMenu] = useState("1");
  const [count, setCount] = useState(1);
  const { data, pickCount, pickData, refetch, pickRefetch, soldCount } =
    useMuItem();
